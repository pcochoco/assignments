...
```
//ios
ssh -i my-key.pem ubuntu@computer_ip

 //window
 ssh -i .\iam-server-key-pair.pem ubuntu@computer_ip
```
...
<img width="830" height="216" alt="image" src="https://github.com/user-attachments/assets/79844b13-c551-45a9-bd9b-008a31523847" />

<img width="797" height="275" alt="image" src="https://github.com/user-attachments/assets/53434deb-6800-420f-9f36-2701b0b40ef4" />

*subnet 이름 규칙
server-public/private-subnet-availabilityzone
<img width="817" height="191" alt="image" src="https://github.com/user-attachments/assets/02fdf48e-77ec-46b3-97d0-205922592ae5" />
